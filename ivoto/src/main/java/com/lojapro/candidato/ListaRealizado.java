...
public class ListaRealizado {
	static final String URL = "http://ivoto.com.br/data_eleicoes/feitos.php";
	RetornoXMLfeitos parser;
	Context mContext;
	NodeList nl;
	static final String KEY_REGISTRO = "feito"; // parent node
	static final String KEY_ID = "id"; 
	static final String KEY_TITULO = "titulo";
	static final String KEY_CONTEUDO = "conteudo";
	static final String KEY_RATE = "rate";
	public ListaRealizado (Context context)
	 {
	       mContext = context;
	...
	public ArrayList<HashMap<String, String>> RetornaLista(){
		...
		parser = new RetornoXMLfeitos(mContext);
		Document doc = null;
		try {
...
class RetornoXMLfeitos extends AsyncTask<String, Void, Document> {
	
	public AsyncResponse delegate = null;
	ProgressDialog pd;
	
	public RetornoXMLfeitos(Context context) {
	...
	protected Document doInBackground(String... urls) {
	   ...
	   String idandroid = Realizado.idandroid;
