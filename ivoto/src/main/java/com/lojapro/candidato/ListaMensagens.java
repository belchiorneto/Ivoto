...
public class ListaMensagens {
	static final String URL = "http://ivoto.com.br/data_eleicoes/mensagens.php";
	RetornoXMLmensagens parser;
	Context mContext;
	NodeList nl;
	static final String KEY_REGISTRO = "mensagem"; // parent node
	static final String KEY_ID = "id"; 
	static final String KEY_TITULO = "titulo";
	static final String KEY_CONTEUDO = "conteudo";
	String idcandidato;
	public ListaMensagens (Context context, String idcandidato)
	 {
	       mContext = context;
	...
	public ArrayList<HashMap<String, String>> RetornaLista(){
		...
		parser = new RetornoXMLmensagens(mContext, idcandidato);
		Document doc = null;
		try {
...
class RetornoXMLmensagens extends AsyncTask<String, Void, Document> {
	
	public AsyncResponse delegate = null;
	ProgressDialog pd;
	String idcandidato;
	public RetornoXMLmensagens(Context context, String idcandidato) {
	...
	protected Document doInBackground(String... urls) {
	   ...
	   URL url;
	   try {
			url = new URL(urls[0] + "?id_android="+idandroid+"&idcandidato="+idcandidato);
