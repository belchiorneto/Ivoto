...
public class ListaAgenda {
	static final String URL = "http://ivoto.com.br/data_eleicoes/agenda.php";
	RetornoXMLagenda parser;
	Context mContext;
	NodeList nl;
	...
	static final String KEY_CONTEUDO = "descricao";
	...
	public ArrayList<HashMap<String, String>> RetornaLista(){
		...
		parser = new RetornoXMLagenda(mContext);
		Document doc = null;
		try {
		...
		// looping through all song nodes <song>
			...
			HashMap<String, String> map = new HashMap<String, String>();
			map.put(KEY_ID,	"1");
			map.put(KEY_DATA,	"Ocorreu um erro ao processar a lista");
...
class RetornoXMLagenda extends AsyncTask<String, Void, Document> {
	
	public AsyncResponse delegate = null;
	ProgressDialog pd;
	
	public RetornoXMLagenda(Context context) {
