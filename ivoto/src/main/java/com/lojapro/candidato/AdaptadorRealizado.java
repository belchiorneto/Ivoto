...
public class AdaptadorRealizado extends BaseAdapter {
    ...
    public AdaptadorRealizado(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        a.getBaseContext();
        data=d;
    ...
    HolderRealizado holder = new HolderRealizado();
    @SuppressLint("InflateParams")
	public View getView(int position, View convertView, ViewGroup parent) {
    	
    	
    	 if(convertView==null){
    	     convertView = inflater.inflate(R.layout.list_row_realizado, null);
    	     convertView.setTag(holder);
    	 }else{
    		 holder = (HolderRealizado) convertView.getTag();
    	 }
