...
public class AdaptadorPropostas extends BaseAdapter {
    ...
    public AdaptadorPropostas(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        a.getBaseContext();
        data=d;
    ...
    HolderPropostas holder = new HolderPropostas();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
    	 ...
    	 if(convertView==null){
    		 ...
    		 holder = (HolderPropostas) convertView.getTag();
    	 }
