...
public class AdaptadorPropostasEleitor extends BaseAdapter {
    ...
    public AdaptadorPropostasEleitor(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        a.getBaseContext();
        data=d;
    ...
    HolderPropostasEleitor holder = new HolderPropostasEleitor();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
    	 if(convertView==null){
    		 ...
    		 holder = (HolderPropostasEleitor) convertView.getTag();
    	 }
       ...
       // song.get(ListaCandidatosBuscados.KEY_NOME);
        System.out.println("Tamanho da lista: " + song.size());
        if(song.size() > 1) {
            ...
            holder.titulo.setText("Nenhuma proposta encontrada");
            holder.conteudo.setText("Ainda não foram cadastradas propostas para sua cidade");
            holder.r.setVisibility(View.GONE);
        }
